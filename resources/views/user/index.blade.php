                ...
                <form method="get" action="{{ request()->url() }}">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="search" name="search" class="form-control" placeholder="Name, Username"
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <div class="ml-auto">
                            <a href="{{ route('users.create') }}" class="btn bg-purple">Add User</a>    
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="@if($user->role === 1) text-danger @endif">{{ $user->name }}</td>
                                    <td>{{ $user->username }}</td>
                                    <td>{{ $user->email }}</td>
